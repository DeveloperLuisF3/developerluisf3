...
ResponsiveProduct.metadata = {
  name: "Ravisankar Chinnam", // My name
  github: "ravisankarchinnam", // Github username
  description: "Full width responsive Ecommerce Product", // Little tagline
  filename: "ResponsiveProduct", // filename of your loader
};
